...
-- Rename scan_logs to scan_events if needed (App uses scan_events)
ALTER TABLE IF EXISTS scan_logs RENAME TO scan_events;

ALTER TABLE scan_events DROP CONSTRAINT IF EXISTS scan_events_venue_id_fkey;
ALTER TABLE scan_events DROP CONSTRAINT IF EXISTS scan_logs_business_id_fkey;
ALTER TABLE scan_events DROP CONSTRAINT IF EXISTS scan_logs_venue_id_fkey;
ALTER TABLE scan_events DROP CONSTRAINT IF EXISTS scan_logs_device_id_fkey;
...
ALTER TABLE scan_events ALTER COLUMN business_id TYPE text;
ALTER TABLE scan_events ALTER COLUMN device_id TYPE text;
